...
<head>
    ...
    <div style="position: fixed; bottom: 280px; left: 8px; z-index: 10; opacity: 0.98;"><a href="/"
            target="_blank" rel="noopener"><img src="https://i.ibb.co/gFRZdPJ/LUCKYSPIN-QQGOBET.gif"
                alt="LUCKY SPIN {{ $setting->nama_web }}" width="70" height="65"></a></div>

    <div style="position: fixed; bottom: 200px; left: 8px; z-index: 10; opacity: 0.98;"><a href="https://bit.ly/4541Mow"
            target="_blank" rel="noopener"><img src="https://i.ibb.co/D9MgFYs/RTP-QQGOBET.gif"
                alt="RTP {{ $setting->nama_web }}" width="70" height="70"></a></div>
    ...
    <div style="position: fixed; bottom: 70px; left: 8px; z-index: 10; opacity: 0.98;"><a href="{{ $setting->tele}}"
            target="_blank" rel="noopener"><img class="wabutton" src="https://i.ibb.co/Msqgcfh/s3.gif" alt="Chat Tele"
    ...
    <style>
        ...
        .scroll-game .scroller, .tittle-wrapper, .u-section-title, .url-box, .wallet-bal{
                                    ...
                                    <div class="flex-row  text-center">
                                        ...
                                        <div class=" footericon-single" style="position: relative">
                                            ...
                                            <ul class="list-inline vertical-hover togglemenu-content"
                                                ...
                                                <li>
                                                    <a target="_blank" href="{{ $setting->tele}}"><i class="icon-chat1"></i></a>
                                                </li>
                                                <li>
