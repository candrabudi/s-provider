        ...
        <div class="row text-left-w">
            <div class="col-xs-6">
                <button class="btn btn-clear btn-refresh-wallet">
                    ...
                    <span class="bal-txt" id="balance">IDR @currency($saldo->saldo + $saldo->bonus)</span>
                </button>
            </div>
            <div class="col-xs-6 noSidePadding i-refresh">
                <a class="btn btn-clear btn-refresh-wallet btn-wallet-load pull-right"><i class="icon-refresh-2"></i></a
                    href="/">
            </div>
        </div>
