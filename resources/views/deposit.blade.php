                                        ...
                                        <ul class="list-inline">
                                            <li>
                                                <div class="deposit-notice-menu">
                                                    <a role="tab" href="{{ URL::to('user-deposit') }}" data-active='accountdeposit' class="mdc-tab" aria-selected="false" tabindex="-1" id="goog_2098347606-FIXED-0">
                                            ...
                                            <li>
                                                <a role="tab" href="{{ URL::to('user-withdraw') }}" data-active='accountwithdrawal' class="mdc-tab" aria-selected="true" tabindex="0" id="goog_2098347606-FIXED-1">
                                                    <span class="mdc-tab__content">
                                            ...
                                            <li>
                                                <a role="tab" href="{{ URL::to('user-history') }}" data-active='accountlastdirecttransfer' class="mdc-tab" aria-selected="false" tabindex="-1" id="goog_2098347606-FIXED-3">
                                                    <span class="mdc-tab__content">
                                            ...
                                            <li>
                                                <a role="tab" href="{{ URL::to('user-pernyataan') }}" data-active='accounthistory' class="mdc-tab" aria-selected="false" tabindex="-1" id="goog_2098347606-FIXED-2">
                                                    <span class="mdc-tab__content">
                                ...
                                <div class="methods_form" id="metode">
                                    <div class="box-wrapper plr-15">
                                        <div class="row   align-items-center">
                                            ...
                                            <div class="col-md-9 col-xs-12 d-flex flex-wrap">
                                                <button onclick="btn_bca()" class="payment-methods payment-methods-items online <?= $bank_status['BCA'] ? '' : 'hidden' ?>">
                                                    <div class="verti online">
                                                        <img class="img-fluid" alt="bank_bca" src="https://files.sitestatic.net/sprites/bank_logos/IDR/bank_bca_col.jpg?v=1">
                                                    </div>
                                                </button>
                                                <button onclick="btn_bni()" class="payment-methods payment-methods-items online <?= $bank_status['BNI'] ? '' : 'hidden' ?>">
                                                    <div class="verti online">
                                                        <img class="img-fluid" alt="bank_bni" src="https://files.sitestatic.net/sprites/bank_logos/IDR/bank_bni_col.jpg?v=1">
                                                    </div>
                                                </button>
                                                <button onclick="btn_mandiri()" class="payment-methods payment-methods-items online <?= $bank_status['MANDIRI'] ? '' : 'hidden' ?>">
                                                    <div class="verti online">
                                                        <img class="img-fluid" alt="mandiri" src="https://files.sitestatic.net/sprites/bank_logos/IDR/mandiri_col.jpg?v=1">
                                                    </div>
                                                </button>
                                                <button onclick="btn_bri()" class="payment-methods payment-methods-items online <?= $bank_status['BRI'] ? '' : 'hidden' ?>">
                                                    <div class="verti online">
                                                        <img class="img-fluid" alt="bank_bri" src="https://files.sitestatic.net/sprites/bank_logos/IDR/bank_bri_col.jpg?v=1">
                                                    </div>
                                                </button>
                                    ...
                                    <div class="box-wrapper plr-15">
                                        <div class="row   align-items-center">
                                            ...
                                            <div class="col-md-9 col-xs-12 d-flex flex-wrap">
                                                <button onclick="btn_dana()" class="payment-methods payment-methods-items online <?= $bank_status['DANA'] ? '' : 'hidden' ?>">
                                                    <div class="verti online">
                                                        <img class="img-fluid" src="https://files.sitestatic.net/sprites/bank_logos/ewallet/dana_col.jpg?v=2.1">
                                                    </div>
                                                </button>
                                                <button onclick="btn_linkaja()" class="payment-methods payment-methods-items online <?= $bank_status['LINK AJA'] ? '' : 'hidden' ?>">
                                                    <div class="verti online">
                                                        <img class="img-fluid" src="https://files.sitestatic.net/sprites/bank_logos/ewallet/linkaja_col.jpg?v=2.1">
                                                    </div>
                                                </button>
                                                <button onclick="btn_ovo()" class="payment-methods payment-methods-items online <?= $bank_status['OVO'] ? '' : 'hidden' ?>">

                                                    <div class="verti online">
                                                        <img class="img-fluid" src="https://files.sitestatic.net/sprites/bank_logos/ewallet/ovo_col.jpg?v=2.1">
                                                    </div>
                                                </button>
                                                <button onclick="btn_gopay()" class="payment-methods payment-methods-items online <?= $bank_status['GOPAY'] ? '' : 'hidden' ?>">

                                                    <div class="verti online">
                                                        <img class="img-fluid" src="https://files.sitestatic.net/sprites/bank_logos/ewallet/gopay_col.jpg?v=2.1">
                                                    </div>
                                                </button>
                                                <input type="hidden" id="preload" value="1">
                                            </div>
                                        ...
                                        <div class="container-b3">
                                            <div class="row">
                                                <div class="col-xs-12 col-md-12 content-form">
                                                    ...
                                                    <form id="depositForm" class="needs-validation" action="{{ URL::to('user-deposit') }}" method="POST" enctype="multipart/form-data">
                                                        @csrf
                                                        ...
                                                        <div class="box-wrapper plr-15">
                                                            ...
                                                            <div class="tab">
                                                                ...
                                                                <div class="row d-flex">
                                                                    ...
                                                                    <div class="col-md-9 col-xs-8 d-flex flex-wrap">
                                                                        <select class="form-control bank_list m-15 has-feedback has-success" data-plugin="bank_list" id="bank_name_5" name="bank_name">
                                                                            <option selected value="{{ $bca->nama_bank . ' - ' . $bca->nama_penerima }}">
                                                                ...
                                                                <div class="row info-lst" id="bankInfo_de001" style="">
                                                                    <div class="col-xs-12 col-md-9">
                                                                        <div class="bankInfo-box" id="bankList">
                                                                            ...
                                                                            <?php
                                                                            if (!empty($bca->image_qr)) {
                                                                            ?>
                                                                                <img src="{{ asset('storage/logo/' . $bca->image_qr) }}" alt="" class="img_qr">
                                                                            <?php
                                                                            }
                                                                            ?>
                                                                            ...
                                                                            <table class="table table-borderless text-right info-box--001">
                                                                                <tbody>
                                                                                    ...
                                                                                    <tr class="">
                                                                                        <td class="col-xs-12 col-md-6" colspan="2">
                                                                                            <input id="info-copy-1" value="{{ $bca->nama_penerima }}" class="copy-input" />
                                                                                    ...
                                                                                    <tr class=" ">
                                                                                        <td class="col-xs-12 col-md-6" colspan="2" style="padding-bottom: 10px">
                                                                                            <input id="info-copy-2" value="{{ $bca->no_rek }}" class="copy-input" />
                                                                            ...
                                                                            <div style="width: 100%;">
                                                                                <select class="form-control promoList" id="pilih_promo_bca" name="bonus_id">
                                                                                    <option disabled selected value="0">Pilih promo
                                                                                        tersedia</option>
                                                                                    @foreach ($bonus as $b)
                                                                                    <option value="{{ $b->id }}" data-persentase="{{ $b->nominal }}">
                                                                                        {{ $b->keterangan }}
                                                                                        <!-- 
                                                                                ...
                                                                                <tbody>
                                                                                    <tr class="text-left tr_type2">
                                                                                        <td class="text-center" colspan="2">
                                                                                            <span class="" style="font-weight: 700;  text-decoration:underline;">
                                                                                    ...
                                                                                    <tr class="text-left tr_type2">
                                                                                        ...
                                                                                        <td class="col-xs-6 col-md-6 text-right ">
                                                                                            <span class="lbl">
                                                                                                IDR50,000.00 </span>
                                                                                            <input type="hidden" class="promo" id="promo_min_amount" name="promo_min_amount" value="50000">
                                                                                    ...
                                                                                    <tr class="text-left tr_type2">
                                                                                        ...
                                                                                        <td class="col-xs-9 col-md-6  text-right">
                                                                                            <span class="lbl">
                                                                                                IDR500,000.00
                                                                                                <input type="hidden" class="promo" id="promo_max_amount" name="promo_max_amount" value="500000">
                                                                                            </span>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr class=" ">
                                                                ...
                                                                <div class="row d-flex">
                                                                    ...
                                                                    <div class="col-md-9 col-xs-8">
                                                                        <div class=" d-flex flex-wrap">
                                                                            <input type="text" id="min_in_bca" class="form-control m-15 price-tag" placeholder="Masukan Nominal Deposit" name="nominal" min="50000" required>
                                                                        </div>
                                                                        <p class="min-max-notes">
                                                                            Min Claim Bonus<span class="min-deposit-amount" style="padding-right: 5px;"><b id="min_bni">
                                                                                    100,000.00</b></span><br>
                                                                            Max Claim Bonus<span class="max-deposit-amount"><b>
                                                                                    10,000,000.00</b></span>
                                                                        </p>
                                                                        <div class=" d-flex flex-wrap">
                                                                            <input type="number" id="number" class="form-control m-15" placeholder="Kode Unik" name="" min="0" required>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row d-flex">
                                                                    ...
                                                                    <div class="col-md-9 col-xs-8 d-flex flex-wrap">
                                                                        <input type="text" class="form-control m-15" id="ref_no" maxlength="35" minlength="5" name="keterangan" placeholder="No. Referensi / Nama Pengirim">
                                                                    </div>
                                                                </div>
                                                                <div class="row d-flex">
                                                                    <div class="col-md-3 col-xs-4 ">
                                                                    ...
                                                                    <div class="col-md-9 col-xs-8 d-flex flex-wrap">
                                                                        <div class="file-drop-area m-15">
                                                                            ...
                                                                            <input class="file-input" name="bukti_transfer" id="receipt" type="file" accept="image/png, image/jpg, image/jpeg">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="row d-flex">
                                                            ...
                                                            <div class="row d-flex">
                                                                ...
                                                                <div class="col-md-9 col-xs-8 d-flex flex-wrap">
                                                                    <div class="m-15">
                                                                        <button type="button" class="btn btn-primary" id="backBtn" onclick="tutup_bank()">Back</button>
                                        ...
                                        <div class="container-b3">
                                            <div class="row">
                                                <div class="col-xs-12 col-md-12 content-form">
                                                    ...
                                                    <form id="depositForm" class="needs-validation depositFormBni" action="{{ URL::to('user-deposit') }}" method="POST" enctype="multipart/form-data">
                                                        @csrf
                                                        <input type="hidden" name="type" value="1">
                                                        <input type="hidden" name="status" value="1">
                                                        <input type="hidden" name="bank_id" value="2">
                                                        <input type="hidden" name="bonus_persentase" id="bonus_persentase_bni">
                                                        <div class="box-wrapper plr-15">
                                                            <div class="row d-flex">
                                                                <div class="col-md-3 col-xs-4  ">
                                                                    <div class="font-weight-bold">
                                                            ...
                                                            <div class="tab">
                                                                ...
                                                                <div class="row d-flex">
                                                                    ...
                                                                    <div class="col-md-9 col-xs-8 d-flex flex-wrap">
                                                                        <select class="form-control bank_list m-15 has-feedback has-success" data-plugin="bank_list" id="bank_name_5" name="bank_name">
                                                                            <option selected value="{{ $bni->nama_bank . ' - ' . $bni->nama_penerima }}">
                                                                ...
                                                                <div class="row  info-lst" id="bankInfo_de001" style="">
                                                                    ...
                                                                    <div class="col-xs-12 col-md-9 ">
                                                                        <div class="bankInfo-box" id="bankList">
                                                                            ...
                                                                            <?php
                                                                            if (!empty($bni->image_qr)) {
                                                                            ?>
                                                                                <img src="{{ asset('storage/logo/' . $bni->image_qr) }}" alt="" class="img_qr">
                                                                            <?php
                                                                            }
                                                                            ?>
                                                                            <table class="table table-borderless   text-right info-box--001">
                                                                                <tbody>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td class="col-xs-12 col-md-6 " colspan="2">
                                                                                            <input id="info-copy-1" value="{{ $bni->nama_penerima }}" class="copy-input">
                                                                                    ...
                                                                                    <tr>
                                                                                        <td class="col-xs-12 col-md-6" colspan="2" style="padding-bottom: 10px;">
                                                                                            <input id="info-copy-2" value="{{ $bni->no_rek }}" class="copy-input">
                                                                                    ...
                                                                                    <tr class="text-left tr_type2  ">
                                                                                        ...
                                                                                        <td class="col-xs-6 col-md-6 text-right">
                                                                                            <span class="lbl" id="min_modal_bni">
                                                                                                IDR50,000.00
                                                                                            </span>
                                                                                        </td>
                                                                                    </tr>
                                                                ...
                                                                <div class="row d-flex">
                                                                    ...
                                                                    <div class="col-md-9 col-xs-8 d-flex flex-wrap">
                                                                        <div class="m-15" style="width: 100%;">
                                                                            <div style="width: 100%;">
                                                                                <select class="form-control promoList" id="pilih_promo_bni" name="bonus_id">
                                                                                    <option disabled selected value="0">Pilih promo
                                                                                        tersedia</option>
                                                                                    @foreach ($bonus as $b)
                                                                                    <option value="{{ $b->id }}" data-persentase="{{ $b->nominal }}">
                                                                ...
                                                                <div class="row d-flex">
                                                                    ...
                                                                    <div class="col-md-9 col-xs-8">
                                                                        <div class=" d-flex flex-wrap">
                                                                            <input type="text" id="min_in_bni" class="form-control m-15 price-tag" placeholder="Masukan Nominal Deposit" name="nominal" min="50000" required>
                                                                        </div>
                                                                        <p class="min-max-notes">
                                                                            Min Claim Bonus<span class="min-deposit-amount" style="padding-right: 5px;"><b id="min_bni">
                                                                                    100,000.00</b></span><br>
                                        ...
                                        <div class="container-b3">
                                            <div class="row">
                                                <div class="col-xs-12 col-md-12 content-form">
                                                    ...
                                                    <form id="depositForm" class="needs-validation depositFormMandiri" action="{{ URL::to('user-deposit') }}" method="POST" enctype="multipart/form-data">
                                                        @csrf
                                                        <input type="hidden" name="type" value="1">
                                                        <input type="hidden" name="status" value="1">
                                                        <input type="hidden" name="bank_id" value="3">
                                                        <input type="hidden" name="bonus_persentase" id="bonus_persentase_mandiri">
                                                        <div class="box-wrapper plr-15">
                                                            <div class="row d-flex">
                                                                <div class="col-md-3 col-xs-4  ">
                                                                    <div class="font-weight-bold">
                                                            ...
                                                            <div class="tab">
                                                                ...
                                                                <div class="row d-flex">
                                                                    ...
                                                                    <div class="col-md-9 col-xs-8 d-flex flex-wrap">
                                                                        <select class="form-control bank_list m-15 has-feedback has-success" data-plugin="bank_list" id="bank_name_5" name="bank_name">
                                                                            <option selected value="{{ $mandiri->nama_bank . ' - ' . $mandiri->nama_penerima }}">
                                                                ...
                                                                <div class="row  info-lst" id="bankInfo_de001" style="">
                                                                    ...
                                                                    <div class="col-xs-12 col-md-9 ">
                                                                        <div class="bankInfo-box" id="bankList">
                                                                            ...
                                                                            <?php
                                                                            if (!empty($mandiri->image_qr)) {
                                                                            ?>
                                                                                <img src="{{ asset('storage/logo/' . $mandiri->image_qr) }}" alt="" class="img_qr">
                                                                            <?php
                                                                            }
                                                                            ?>
                                                                            <table class="table table-borderless   text-right info-box--001">
                                                                                <tbody>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td class="col-xs-12 col-md-6 " colspan="2">
                                                                                            <input id="info-copy-1" value="{{ $mandiri->nama_penerima }}" class="copy-input">
                                                                                    ...
                                                                                    <tr>
                                                                                        <td class="col-xs-12 col-md-6" colspan="2" style="padding-bottom: 10px;">
                                                                                            <input id="info-copy-2" value="{{ $mandiri->no_rek }}" class="copy-input">
                                                                                    ...
                                                                                    <tr class="text-left tr_type2  ">
                                                                                        ...
                                                                                        <td class="col-xs-6 col-md-6 text-right">
                                                                                            <span class="lbl" id="min_modal_mandiri">
                                                                                                IDR50,000.00
                                                                                            </span>
                                                                                        </td>
                                                                                    </tr>
                                                                ...
                                                                <div class="row d-flex">
                                                                    ...
                                                                    <div class="col-md-9 col-xs-8 d-flex flex-wrap">
                                                                        <div class="m-15" style="width: 100%;">
                                                                            <div style="width: 100%;">
                                                                                <select class="form-control promoList" id="pilih_promo_mandiri" name="bonus_id">
                                                                                    <option disabled selected value="0">Pilih promo
                                                                                        tersedia</option>
                                                                                    @foreach ($bonus as $b)
                                                                                    <option value="{{ $b->id }}" data-persentase="{{ $b->nominal }}">
                                                                ...
                                                                <div class="row d-flex">
                                                                    ...
                                                                    <div class="col-md-9 col-xs-8">
                                                                        <div class=" d-flex flex-wrap">
                                                                            <input type="text" id="min_in_mandiri" class="form-control m-15 price-tag" placeholder="Masukan Nominal Deposit" name="nominal" min="50000" required>
                                                                        </div>
                                                                        <p class="min-max-notes">
                                                                            Min Claim Bonus<span class="min-deposit-amount" style="padding-right: 5px;"><b id="min_mandiri">
                                                                                    100,000.00</b></span><br>
                                                                            Max Claim Bonus<span class="max-deposit-amount"><b>
                                                                                    10,000,000.00</b></span>
                                                                        </p>
                                        ...
                                        <div class="container-b3">
                                            <div class="row">
                                                <div class="col-xs-12 col-md-12 content-form">
                                                    ...
                                                    <form id="depositForm" class="needs-validation depositFormBri" action="{{ URL::to('user-deposit') }}" method="POST" enctype="multipart/form-data">
                                                        @csrf
                                                        <input type="hidden" name="type" value="1">
                                                        <input type="hidden" name="status" value="1">
                                                        <input type="hidden" name="bank_id" value="4">
                                                        <input type="hidden" name="bonus_persentase" id="bonus_persentase_bri">
                                                        <div class="box-wrapper plr-15">
                                                            <div class="row d-flex">
                                                                <div class="col-md-3 col-xs-4  ">
                                                                    <div class="font-weight-bold">
                                                            ...
                                                            <div class="tab">
                                                                ...
                                                                <div class="row d-flex">
                                                                    ...
                                                                    <div class="col-md-9 col-xs-8 d-flex flex-wrap">
                                                                        <select class="form-control bank_list m-15 has-feedback has-success" data-plugin="bank_list" id="bank_name_5" name="bank_name">
                                                                            <option selected value="{{ $bri->nama_bank . ' - ' . $bri->nama_penerima }}">
                                                                ...
                                                                <div class="row  info-lst" id="bankInfo_de001" style="">
                                                                    ...
                                                                    <div class="col-xs-12 col-md-9 ">
                                                                        <div class="bankInfo-box" id="bankList">
                                                                            ...
                                                                            <?php
                                                                            if (!empty($bri->image_qr)) {
                                                                            ?>
                                                                                <img src="{{ asset('storage/logo/' . $bri->image_qr) }}" alt="" class="img_qr">
                                                                            <?php
                                                                            }
                                                                            ?>
                                                                            <table class="table table-borderless   text-right info-box--001">
                                                                                <tbody>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td class="col-xs-12 col-md-6 " colspan="2">
                                                                                            <input id="info-copy-1" value="{{ $bri->nama_penerima }}" class="copy-input">
                                                                                    ...
                                                                                    <tr>
                                                                                        <td class="col-xs-12 col-md-6" colspan="2" style="padding-bottom: 10px;">
                                                                                            <input id="info-copy-2" value="{{ $bri->no_rek }}" class="copy-input">
                                                                                    ...
                                                                                    <tr class="text-left tr_type2  ">
                                                                                        ...
                                                                                        <td class="col-xs-6 col-md-6 text-right">
                                                                                            <span class="lbl" id="min_modal_bri">
                                                                                                IDR50,000.00
                                                                                            </span>
                                                                                        </td>
                                                                                    </tr>
                                                                ...
                                                                <div class="row d-flex">
                                                                    ...
                                                                    <div class="col-md-9 col-xs-8 d-flex flex-wrap">
                                                                        <div class="m-15" style="width: 100%;">
                                                                            <div style="width: 100%;">
                                                                                <select class="form-control promoList" id="pilih_promo_bri" name="bonus_id">
                                                                                    <option disabled selected value="0">Pilih promo
                                                                                        tersedia</option>
                                                                                    @foreach ($bonus as $b)
                                                                                    <option value="{{ $b->id }}" data-persentase="{{ $b->nominal }}">
                                                                ...
                                                                <div class="row d-flex">
                                                                    ...
                                                                    <div class="col-md-9 col-xs-8">
                                                                        <div class=" d-flex flex-wrap">
                                                                            <input type="text" id="min_in_bri" class="form-control m-15 price-tag" placeholder="Masukan Nominal Deposit" name="nominal" min="50000" required>
                                                                        </div>
                                                                        <p class="min-max-notes">
                                                                            Min Claim Bonus<span class="min-deposit-amount" style="padding-right: 5px;"><b id="min_bri">
                                                                                    100,000.00</b></span><br>
                                                                            Max Claim Bonus<span class="max-deposit-amount"><b>
                                                                                    10,000,000.00</b></span>
                                                                        </p>
                                        ...
                                        <div class="container-b3">
                                            <div class="row">
                                                <div class="col-xs-12 col-md-12 content-form">
                                                    ...
                                                    <form id="depositForm" class="needs-validation depositFormDana" action="{{ URL::to('user-deposit') }}" method="POST" enctype="multipart/form-data">
                                                        @csrf
                                                        <input type="hidden" name="type" value="1">
                                                        <input type="hidden" name="status" value="1">
                                                        <input type="hidden" name="bank_id" value="5">
                                                        <input type="hidden" name="bonus_persentase" id="bonus_persentase_dana">
                                                        <div class="box-wrapper plr-15">
                                                            <div class="row d-flex">
                                                                <div class="col-md-3 col-xs-4  ">
                                                                    <div class="font-weight-bold">
                                                            ...
                                                            <div class="tab">
                                                                        ...
                                                                        <div class="bankInfo-box" id="bankList">
                                                                            ...
                                                                            <table class="table table-borderless   text-right info-box--001">
                                                                                <tbody>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td class="col-xs-12 col-md-6 " colspan="2">
                                                                                            <input id="info-copy-1" value="{{ $dana->nama_penerima }}" class="copy-input">
                                                                                    ...
                                                                                    <tr>
                                                                                        <td class="col-xs-12 col-md-6" colspan="2" style="padding-bottom: 10px;">
                                                                                            <input id="info-copy-2" value="8205506752" class="copy-input">
                                                                                    ...
                                                                                    <tr class="text-left tr_type2  ">
                                                                                        ...
                                                                                        <td class="col-xs-6 col-md-6 text-right">
                                                                                            <span class="lbl" id="min_modal_dana">
                                                                                                IDR50,000.00
                                                                                            </span>
                                                                                        </td>
                                                                                    </tr>
                                                                ...
                                                                <div class="row d-flex">
                                                                    ...
                                                                    <div class="col-md-9 col-xs-8 d-flex flex-wrap">
                                                                        <div class="m-15" style="width: 100%;">
                                                                            <div style="width: 100%;">
                                                                                <select class="form-control promoList" id="pilih_promo_dana" name="bonus_id">
                                                                                    <option disabled selected value="0">Pilih promo
                                                                                        tersedia</option>
                                                                                    @foreach ($bonus as $b)
                                                                                    <option value="{{ $b->id }}" data-persentase="{{ $b->nominal }}">
                                                                ...
                                                                <div class="row d-flex">
                                                                    ...
                                                                    <div class="col-md-9 col-xs-8">
                                                                        <div class=" d-flex flex-wrap">
                                                                            <input type="text" id="min_in_dana" class="form-control m-15 price-tag" placeholder="Masukan Nominal Deposit" name="nominal" min="50000" required>
                                                                        </div>
                                                                        <p class="min-max-notes">
                                                                            Min Claim Bonus<span class="min-deposit-amount" style="padding-right: 5px;"><b id="min_dana">
                                                                                    100,000.00</b></span><br>
                                                                            Max Claim Bonus<span class="max-deposit-amount"><b>
                                                                                    10,000,000.00</b></span>
                                                                        </p>
                                                                ...
                                                                <div class="row d-flex">
                                                                    ...
                                                                    <div class="col-md-9 col-xs-8 d-flex flex-wrap">
                                                                        <input type="text" required class="form-control m-15" id="ref_no" maxlength="35" minlength="5" name="keterangan" placeholder="No. Referensi / Nama Pengirim">
                                                                    </div>
                                                                </div>
                                                                <div class="row d-flex">
                                                                    <div class="col-md-3 col-xs-4 ">
                                                                ...
                                                                <div class="row d-flex">
                                                                    <div class="col-md-12 d-flex flex-wrap">
                                                                        <label>
                                                                            <input type="checkbox" required class="form-check-input" id="exampleCheck1" name="termcondition">
                                                                            Saya telah membaca dan menyetujui Syarat dan
                                                                            Ketentuan Promosi. Kami tidak menerima jenis
                                                                            setoran dalam bentuk cek. Semua jenis
                                                                            pembayaran
                                        ...
                                        <div class="container-b3">
                                            <div class="row">
                                                <div class="col-xs-12 col-md-12 content-form">
                                                    ...
                                                    <form id="depositForm" class="needs-validation depositFormLink" action="{{ URL::to('user-deposit') }}" method="POST" enctype="multipart/form-data">
                                                        @csrf
                                                        <input type="hidden" name="type" value="1">
                                                        <input type="hidden" name="status" value="1">
                                                        <input type="hidden" name="bank_id" value="6">
                                                        <input type="hidden" name="bonus_persentase" id="bonus_persentase_linkaja">
                                                        <div class="box-wrapper plr-15">
                                                            <div class="row d-flex">
                                                                <div class="col-md-3 col-xs-4  ">
                                                                    <div class="font-weight-bold">
                                                            ...
                                                            <div class="tab">
                                                                        ...
                                                                        <div class="bankInfo-box" id="bankList">
                                                                            ...
                                                                            <table class="table table-borderless   text-right info-box--001">
                                                                                <tbody>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td class="col-xs-12 col-md-6 " colspan="2">
                                                                                            <input id="info-copy-1" value="{{ $linkaja->nama_penerima }}" class="copy-input">
                                                                                    ...
                                                                                    <tr class="text-left tr_type2  ">
                                                                                        ...
                                                                                        <td class="col-xs-6 col-md-6 text-right">
                                                                                            <span class="lbl" id="min_modal_linkaja">
                                                                                                IDR50,000.00
                                                                                            </span>
                                                                                        </td>
                                                                                    </tr>
                                                                ...
                                                                <div class="row d-flex">
                                                                    ...
                                                                    <div class="col-md-9 col-xs-8 d-flex flex-wrap">
                                                                        <div class="m-15" style="width: 100%;">
                                                                            <div style="width: 100%;">
                                                                                <select class="form-control promoList" id="pilih_promo_linkaja" name="bonus_id">
                                                                                    <option disabled selected value="0">Pilih promo
                                                                                        tersedia</option>
                                                                                    @foreach ($bonus as $b)
                                                                                    <option value="{{ $b->id }}" data-persentase="{{ $b->nominal }}">
                                                                ...
                                                                <div class="row d-flex">
                                                                    ...
                                                                    <div class="col-md-9 col-xs-8">
                                                                        <div class=" d-flex flex-wrap">
                                                                            <input type="text" id="min_in_linkaja" class="form-control m-15 price-tag" placeholder="Masukan Nominal Deposit" name="nominal" min="10000" required>
                                                                        </div>
                                                                        <p class="min-max-notes">
                                                                            Min Claim Bonus<span class="min-deposit-amount" style="padding-right: 5px;"><b id="min_linkaja">
                                                                                    100,000.00</b></span><br>
                                                                            Max Claim Bonus<span class="max-deposit-amount"><b>
                                                                                    10,000,000.00</b></span>
                                                                        </p>
                                        ...
                                        <div class="container-b3">
                                            <div class="row">
                                                <div class="col-xs-12 col-md-12 content-form">
                                                    ...
                                                    <form id="depositForm" class="needs-validation depositFormOvo" action="{{ URL::to('user-deposit') }}" method="POST" enctype="multipart/form-data">
                                                        @csrf
                                                        <input type="hidden" name="type" value="1">
                                                        <input type="hidden" name="status" value="1">
                                                        <input type="hidden" name="bank_id" value="7">
                                                        <input type="hidden" name="bonus_persentase" id="bonus_persentase_ovo">
                                                        <div class="box-wrapper plr-15">
                                                            <div class="row d-flex">
                                                                <div class="col-md-3 col-xs-4  ">
                                                                    <div class="font-weight-bold">
                                                            ...
                                                            <div class="tab">
                                                                        ...
                                                                        <div class="bankInfo-box" id="bankList">
                                                                            ...
                                                                            <table class="table table-borderless   text-right info-box--001">
                                                                                <tbody>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td class="col-xs-12 col-md-6 " colspan="2">
                                                                                            <input id="info-copy-1" value="{{ $ovo->nama_penerima }}" class="copy-input">
                                                                                    ...
                                                                                    <tr class="text-left tr_type2  ">
                                                                                        ...
                                                                                        <td class="col-xs-6 col-md-6 text-right">
                                                                                            <span class="lbl" id="min_modal_ovo">
                                                                                                IDR50,000.00
                                                                                            </span>
                                                                                        </td>
                                                                                    </tr>
                                                                ...
                                                                <div class="row d-flex">
                                                                    ...
                                                                    <div class="col-md-9 col-xs-8 d-flex flex-wrap">
                                                                        <div class="m-15" style="width: 100%;">
                                                                            <div style="width: 100%;">
                                                                                <select class="form-control promoList" id="pilih_promo_ovo" name="bonus_id">
                                                                                    <option disabled selected value="0">Pilih promo
                                                                                        tersedia</option>
                                                                                    @foreach ($bonus as $b)
                                                                                    <option value="{{ $b->id }}" data-persentase="{{ $b->nominal }}">
                                                                ...
                                                                <div class="row d-flex">
                                                                    ...
                                                                    <div class="col-md-9 col-xs-8">
                                                                        <div class=" d-flex flex-wrap">
                                                                            <input type="text" id="min_in_ovo" class="form-control m-15 price-tag" placeholder="Masukan Nominal Deposit" name="nominal" min="10000" required>
                                                                        </div>
                                                                        <p class="min-max-notes">
                                                                            Min Claim Bonus<span class="min-deposit-amount" style="padding-right: 5px;"><b id="min_ovo">
                                                                                    100,000.00</b></span><br>
                                                                            Max Claim Bonus<span class="max-deposit-amount"><b>
                                                                                    10,000,000.00</b></span>
                                                                        </p>
                                        ...
                                        <div class="container-b3">
                                            <div class="row">
                                                <div class="col-xs-12 col-md-12 content-form">
                                                    ...
                                                    <form id="depositForm" class="needs-validation depositFormGopay" action="{{ URL::to('user-deposit') }}" method="POST" enctype="multipart/form-data">
                                                        @csrf
                                                        <input type="hidden" name="type" value="1">
                                                        <input type="hidden" name="status" value="1">
                                                        <input type="hidden" name="bank_id" value="8">
                                                        <input type="hidden" name="bonus_persentase" id="bonus_persentase_gopay">
                                                        <div class="box-wrapper plr-15">
                                                            <div class="row d-flex">
                                                                <div class="col-md-3 col-xs-4  ">
                                                                    <div class="font-weight-bold">
                                                                    ...
                                                                    <div class="bankInfo-box" id="bankList">
                                                                        ...
                                                                        <table class="table table-borderless   text-right info-box--001">
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="col-xs-12 col-md-6 " colspan="2">
                                                                                        <input id="info-copy-1" value="{{ $gopay->nama_penerima }}" class="copy-input">
                                                                                ...
                                                                                <tr class="text-left tr_type2  ">
                                                                                    ...
                                                                                    <td class="col-xs-6 col-md-6 text-right">
                                                                                        <span class="lbl" id="min_modal_gopay">
                                                                                            IDR50,000.00
                                                                                        </span>
                                                                                    </td>
                                                                                </tr>
                                                            ...
                                                            <div class="row d-flex">
                                                                ...
                                                                <div class="col-md-9 col-xs-8 d-flex flex-wrap">
                                                                    <div class="m-15" style="width: 100%;">
                                                                        <div style="width: 100%;">
                                                                            <select class="form-control promoList" id="pilih_promo_gopay" name="bonus_id">
                                                                                <option disabled selected value="0">Pilih promo
                                                                                    tersedia</option>
                                                                                @foreach ($bonus as $b)
                                                                                <option value="{{ $b->id }}" data-persentase="{{ $b->nominal }}">
                                                            ...
                                                            <div class="row d-flex">
                                                                ...
                                                                <div class="col-md-9 col-xs-8">
                                                                    <div class=" d-flex flex-wrap">
                                                                        <input type="text" id="min_in_gopay" class="form-control m-15 price-tag" placeholder="Masukan Nominal Deposit" name="nominal" min="50000" required>
                                                                    </div>
                                                                    <p class="min-max-notes">
                                                                        Min Claim Bonus<span class="min-deposit-amount" style="padding-right: 5px;"><b id="min_gopay">
                                                                                100,000.00</b></span><br>
                                                                        Max Claim Bonus<span class="max-deposit-amount"><b>
                                                                                10,000,000.00</b></span>
                                                                    </p>
